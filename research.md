...
- **Semantic opacity and neural attention.** What (if anything) NMT and LLM architectures reveal about meaning, interlingua, and cross-lingual alignment.
- **Translation quality evaluation.** Automatic metrics (COMET, MetricX), human evaluation, and their correlation — with practical applications for freelance translators and small language service providers.

## The Translation Analytics series
...
*(Add links to the arXiv versions and code repositories here.)*

## Earlier work

Before turning to language and AI, I worked extensively in the history and philosophy of science, including the philosophy of spacetime, persistence, and the history of astronomy.
